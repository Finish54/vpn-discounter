...
ru: {
  ...
  "doc.terms.h":"Пользовательское соглашение",
  "doc.terms.b":"ЗАГЛУШКА. Здесь размещается текст пользовательского соглашения VPN Discounter. Замените содержимое в assets/js/i18n.js либо выведите ссылку на отдельную страницу /terms.html.|Оферта, порядок оплаты и возврата, зоны ответственности сторон, правила использования сервиса.",
  "doc.privacy.h":"Политика конфиденциальности",
  "doc.privacy.b":"ЗАГЛУШКА. Здесь размещается текст политики конфиденциальности. Замените содержимое в assets/js/i18n.js либо выведите ссылку на отдельную страницу /privacy.html.|Какие данные собираются, сроки хранения, передача третьим лицам, права пользователя.",
  "doc.close":"Закрыть",
  "ping":"пинг"
},
...
en: {
  ...
  "doc.terms.h":"Terms of Service",
  "doc.terms.b":"PLACEHOLDER. Put your Terms of Service text here. Edit assets/js/i18n.js or link to a standalone /terms.html page.|Offer, payment and refund rules, liability, acceptable use.",
  "doc.privacy.h":"Privacy Policy",
  "doc.privacy.b":"PLACEHOLDER. Put your Privacy Policy text here. Edit assets/js/i18n.js or link to a standalone /privacy.html page.|What data is collected, retention, third parties, user rights.",
  "doc.close":"Close",
  "ping":"ping"
}
};
